...
document.addEventListener('DOMContentLoaded',()=>{
  const params=new URLSearchParams(window.location.search), lp=params.get('lang'); setLang(resolveInitialLanguage(lp,'en'),{persist:false}); initTheme();applyTranslations();langSwitcher.value=currentLang;
